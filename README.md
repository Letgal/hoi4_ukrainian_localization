Це&nbsp;— *GitHub*-репозиторій нині найпопулярнішого українського перекладу *Hearts of Iron IV*. Переклад оновлений до версії гри ***1.14.6***.
...
1. Завантажте останній реліз локалізації ([3.2.3](https://github.com/Letgal/hoi4_ukrainian_localization/releases/download/release-v3.2.3/hoi4_ukrainian_localization_v3.2.3.zip))
